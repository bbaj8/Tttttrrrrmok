...
- مرحبـاً بـك عزيـزي {}
فـي بـوت كود تيرمكس$بايروجرام لن

- يعمـل هـذا البـوت لمساعدتـك بطريقـة سهلـه للحصـول على كـود تيرمكـس والبايروجرام تم انشـاء هـذا البـوت بواسطـة : @R125R
    """
    ...
    buttons = [
        ...
        [InlineKeyboardButton("- قناة السورس", url="https://t.me/R125R")],
        [
...
- بـوت استخـراج كـود تيرمكـس خـاص بســورس  دايفل
- قنـاة السـورس : @R125R
